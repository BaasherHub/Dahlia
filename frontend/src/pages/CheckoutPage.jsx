...
const FIELDS = [
  { name: 'name',    label: 'Full Name',        type: 'text',  placeholder: 'Jane Smith',          colSpan: 2 },
  { name: 'email',   label: 'Email',             type: 'email', placeholder: 'jane@example.com',    colSpan: 2 },
  { name: 'street',  label: 'Street Address',    type: 'text',  placeholder: '123 Main Street',     colSpan: 2 },
  { name: 'city',    label: 'City',              type: 'text',  placeholder: 'Toronto' },
  { name: 'state',   label: 'State / Province',  type: 'text',  placeholder: 'ON' },
  { name: 'zip',     label: 'ZIP / Postal Code', type: 'text',  placeholder: 'M5V 2T6' },
  { name: 'country', label: 'Country',           type: 'text',  placeholder: 'CA' },
  { name: 'phone',   label: 'Phone (optional)',  type: 'tel',   placeholder: '+1 416 000 0000',     colSpan: 2 },
];
